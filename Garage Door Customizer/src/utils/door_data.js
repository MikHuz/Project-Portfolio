...
let commonGlass = {Plain:plain,Obscure:obscure,Frosted:frosted,Tinted:tinted}
...
/*Each door is a master object, contains all the specific door's combinations, prices, and shared data*/
let Doors = {
traditional: {
  "Raised Panel": {
    available:true,
    ...
    Insulation: {
      ...
      Standard: { "Short Panel": 2250, "Long Panel": 4250 },
      PremiumImg: premiumRaisedPanel,
      Premium: { "Short Panel": 2283, "Long Panel": 4283 }
    },
    ...
    windows: {
      position: {},
      commonGlass:{...commonGlass},
      glass: {},
      designerGlass: null,
      commonDesignerGlass:{...commonDesignerGlass},
      inserts: {
        "Any Design": {
          ...commonInserts
        }
  ...
  "Stamped Carriage House": {
    ...
    Insulation: {
      ...
      Standard: { "Short Panel": 5250, "Long Panel": 5950 },
      PremiumImg: premiumStampedCarriage,
      Premium: { "Short Panel": 5283, "Long Panel": 5983 }
    },
    commonSolidColors:{...commonSolidColors},
    colors: {},
    commonWoodTones:{...commonWoodTones},
...
contemporary : {
  ...
  "Skyline Flush": {
    ...
    Insulation: {
      ...
      Standard: { "No Or Short Windows": 2150, "Long Windows": 4150 },
      PremiumImg: premiumInsulation,
      Premium: { "No Or Short Windows": 2127, "Long Windows": 2147 }
    },
    commonSolidColors:{...commonSolidColors},
    colors: {},
    commonWoodTones:{...commonWoodTones},
  ...
  "Aluminum": {
    ...
    Insulation: {
      ...
      Standard: { "Full View": "3295R" },
      PremiumImg: aluminumPremium,
      Premium: { "Full View": "3297R" }
    },
    windows: {
      commonGlass:{...commonGlass},
      glass: {},
  ...
  "Sterling": {
    ...
    commonSolidColors:{
      "Bone White": "#F8F4EC", "Sandstone": "#E8E4d4", Almond: "#E8dCC4",
      "Medium Bronze": "#584C3C", Charcoal: "#404444", "Slate Gray": "#807c74",
      "Deep Black": "#281c24", "Hartford Green": "#283c3c"},
    colors: {},
    commonWoodTones:{...commonWoodTones},
    woods: {},
    windows: {
...
carriage: {
  "Steel Overlay": {
    ...
    style: "Steel Overlay",
    designs: {
      "10": ten, "10A": tenA, "11": eleven, "11A": elevenA,
      "12": twelve, "12A": twelveA, "33": thirtyThree, "33A": thirtyThreeA
    },
    Insulation: {
...
export async function getDoors() {
  ...
  for (let doorName in Doors["traditional"]){
    Doors["traditional"][doorName].prices = prices["Traditional"]?.[doorName] || {}
  }
  for (let doorName in Doors["contemporary"]){
    Doors["contemporary"][doorName].prices = prices["Contemporary"]?.[doorName] || {}
  }
